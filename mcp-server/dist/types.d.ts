 ...
 */
export type AgentType = 'chatgpt_moderator' | 'gemini3_research' | 'gemini_gem_curator' | 'grok4_safety' | 'deepseek_reasoning' | 'claude_builder';
export type TaskStatus = 'pending' | 'routed' | 'in_progress' | 'review' | 'approved' | 'rejected' | 'completed' | 'blocked';
export type WorkflowPhase = 'intake_research' | 'conversion_preparation' | 'reasoning_analysis' | 'implementation' | 'validation_safety' | 'deployment';
export type ArtifactType = 'raw_session' | 'curated_segment' | 'research_brief' | 'latex_document' | 'reasoning_report' | 'implementation_code' | 'validation_report' | 'deployment_artifact';
