...
export class WorkflowManager {
  private currentPhase: WorkflowPhase = 'intake_research';
  private phaseHistory: Array<{ phase: WorkflowPhase; timestamp: string }> = [];
  ...
  }): { success: boolean; currentPhase: WorkflowPhase; message: string } {
   ...
   * Get phase history
   */
  getPhaseHistory(): Array<{ phase: WorkflowPhase; timestamp: string }> {
